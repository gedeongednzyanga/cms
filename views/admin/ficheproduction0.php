...
<body>
    ...
    <div class="container-fluid invoice-container">
        ...
        <main>
            <div class="row">
                <div class="col-sm-12 fw-600 text-center"><strong>FICHE DE PRODUCTION DU
                        <?= date('d/m/Y', strtotime($_SESSION['date1']))  ?> AU
                        <?= date('d/m/Y', strtotime($_SESSION['date2']))  ?></strong></div>
            </div>
            <hr>
                    ...
                    <div class="table-responsive">
                        <table class="table  table-bordered mb-0">
                            <thead class="card-header">
                                <tr>
                                    <td class="col-3"><strong>Date</strong></td>
                            ...
                            <tbody>
                                ...
                                foreach ($managerProduction->_getProductionBetweenTwoDate($_SESSION['date1'], $_SESSION['date2'], 'Production') as $data1) :
                                ?>
                                <tr>
                                    <td colspan="7" class="fw-600">
                                        <?= date('d-m-Y', strtotime($data1->getDateprod())) ?></td>
                                </tr>
                                <?php foreach ($managerProduction->_getOneProductionDate($data1->getDateprod()) as $data2) : ?>
                                <tr>
                                    <td style="background-color:black; border: 0px solid black; margin:0;"></td>
                                    <td class="col-3"><?= $data2->getQuantiteprod() . '' . $data2->getDesignationu() ?>
                                    </td>
                                    <td class="col-4 text-1"><?= $data2->getDesignationprod() ?></td>
                                    <td class="col-2 text-center">
                                        <?= ($data2->getQuantiteprod() - $data2->getQuantiteperd()) . $data2->getDesignationu() ?>
                                    </td>
                                    <td class="col-1 text-center">
                                        <?= $data2->getQuantiteperd() . $data2->getDesignationu() ?></td>
                                    <td class="col-2 text-center"><?= $data2->getCarburant() . 'L' ?></td>
